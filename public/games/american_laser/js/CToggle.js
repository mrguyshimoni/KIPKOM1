function CToggle(iXPos,iYPos,oSprite,bActive,bAttach){
    var _bActive;
    var _aCbCompleted;
    var _aCbOwner;
    var _oButton;
    ...
    this._init = function(iXPos,iYPos,oSprite,bActive,bAttach){
    ...
    this._init(iXPos,iYPos,oSprite,bActive,bAttach);
}