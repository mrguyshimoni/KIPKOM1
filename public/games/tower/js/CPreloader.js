function CPreloader() {
    ...
    this.attachSprites = function () {
        ...
        _oBg.graphics.beginFill(COLOR_GRADIENTS_STACKS[Math.floor(Math.random() * COLOR_GRADIENTS_STACKS.length)]).drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
        _oContainer.addChild(_oBg);

        _oFBg = createBitmap(s_oSpriteLibrary.getSprite('bg_menu'));
        _oContainer.addChild(_oFBg);
