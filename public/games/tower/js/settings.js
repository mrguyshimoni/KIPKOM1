...
var STACK_DIRECTIONS = {x: 0.5, y: 0.5};

var MS_FADE_ANIM = 250;
var MS_SCROLL_CONTAINER_STACK = 750;
var MS_PERFECT_TEXT = 1000;

var PERFECT_TEXT_START_POINT = {x: CANVAS_WIDTH_HALF, y: CANVAS_HEIGHT-150};

var PERFECT_TEXT_END_POINT = {x: CANVAS_WIDTH_HALF, y: CANVAS_HEIGHT - 300};

var MS_WAIT_SHOW_GAME_OVER_PANEL = 500;

var PLANES_COLOR_1 = {r: 200, g: 0, b: 0, a: 1};
var LINES_COLOR_1 = {r: 0, g: 200, b: 0, a: 1};
var PLANES_COLOR_2 = {r: 0, g: 0, b: 200, a: 1};
var LINES_COLOR_2 = {r: 255, g: 255, b: 0, a: 1};

var MS_TIME_ZOOM_OUT = 1000;

var MS_TIME_PERFECT_HIT = 500;

var CONTAINER_STACK_POS = {x: CANVAS_WIDTH_HALF, y: CANVAS_HEIGHT_HALF};
var LINES_WIDTH = 1;

var ANGLE_STACK = 35 * (Math.PI / 180);

var DEFAULT_DIR = {x: Math.cos(ANGLE_STACK), y: Math.sin(ANGLE_STACK)};

var DIRECTION_STACKS = [DEFAULT_DIR, {x: -DEFAULT_DIR.x, y: DEFAULT_DIR.y}, {x: DEFAULT_DIR.x, y: -DEFAULT_DIR.y},
    {x: -DEFAULT_DIR.x, y: -DEFAULT_DIR.y}, {x: 0, y: 0}];

var STACK_DIMENSION = {x: 200, y: 140};
...
var STACKS_LIMIT_POSITION = [{x: 966, y: 620}, {x: 425, y: 598},
    {x: 942, y: 236.5}, {x: 426, y: 242}];

var STACKS_START_POSITION = [{x: 426, y: 242, dir: LEFT_UP}, {x: 942, y: 236.5, dir: LEFT_DOWN}];

var START_EDGES_POSITION = [{startX: 0, startY: -STACK_DIMENSION.y, endX: STACK_DIMENSION.x, endY: 0, type: EDGE_RIGHT_UP},
    {startX: STACK_DIMENSION.x, startY: 0, endX: 0, endY: STACK_DIMENSION.y, type: EDGE_RIGHT_DOWN},
    {startX: 0, startY: STACK_DIMENSION.y, endX: -STACK_DIMENSION.x, endY: 0, type: EDGE_LEFT_DOWN},
    {startX: -STACK_DIMENSION.x, startY: 0, endX: 0, endY: -STACK_DIMENSION.y, type: EDGE_LEFT_UP}];
