function CAreYouSurePanel(oParentContainer) {
    ...
    this._init = function () {
        ...
        _oMsgStroke = new createjs.Text(TEXT_ARE_SURE, "80px " + FONT_GAME, TEXT_COLOR_STROKE);
        _oMsgStroke.x = CANVAS_WIDTH / 2;
        _oMsgStroke.y = 550;
        _oMsgStroke.textAlign = "center";
        _oMsgStroke.textBaseline = "middle";
        _oMsgStroke.outline = 1;
        _oContainer.addChild(_oMsgStroke);

        _oMsg = new createjs.Text(_oMsgStroke.text, "80px " + FONT_GAME, TEXT_COLOR);
